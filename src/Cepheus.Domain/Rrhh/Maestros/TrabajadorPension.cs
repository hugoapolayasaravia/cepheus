...
{
    /// <summary>
    /// Información pensionaria (AFP/ONP) del trabajador
    ///
    /// Legacy: rrhh.trabajador_pension (SQL Server).
    ...
    /// </summary>
    public class TrabajadorPension : IAuditableEntity
    {
        ...
        public string? TipoAfiliacionCode { get; set; } // legacy: tipo_afiliacion_id
        public TipoAfiliacion? TipoAfiliacion { get; set; }
        public string? AfpCode { get; set; } // legacy: afp_id
        public Afp? Afp { get; set; }
        public DateTime? FechaAfiliacion { get; set; } // legacy: fecha_afiliacion
        public string? NumeroAfp { get; set; } // legacy: numero_afp
        public string? RegimenPensionarioCode { get; set; } // legacy: regimen_pensionario_id
        public RegimenPensionario? RegimenPensionario { get; set; }
        public string? TipoPensionCode { get; set; } // legacy: tipo_pension_id
        public TipoPension? TipoPension { get; set; }
        public string? NumeroCarnetSsp { get; set; } // legacy: numero_carnet_ssp
