...
namespace Cepheus.Domain.Rrhh.Maestros
{
    ...
    ///
    /// Legacy: rrhh.trabajador_salud (SQL Server).
    ...
    /// </summary>
    public class TrabajadorSalud : IAuditableEntity
    {
        ...
        public string? TipoSangreCode { get; set; } // legacy: tipo_sangre_id
        public TipoSangre? TipoSangre { get; set; }
        public string? AlergiaCode { get; set; } // legacy: alergia_id
        public Alergia? Alergia { get; set; }
        public string? Otros { get; set; } // legacy: otros
        public DateTime? FechaEvaluacionMedica { get; set; } // legacy: fecha_evaluacion_medica
        public string? Observaciones { get; set; } // legacy: observaciones
