...
{
    /// <summary>
    /// Registro de fechas de vacaciones tomadas por el trabajador
    ///
    /// Legacy: rrhh.trabajador_vacacion (SQL Server).
    ...
    /// </summary>
    public class TrabajadorVacacion : IAuditableEntity
    {
        ...
        public DateTime? FechaVacaciones { get; set; } // legacy: fecha_vacaciones
