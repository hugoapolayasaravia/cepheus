...
{
    /// <summary>
    /// Formación académica del trabajador (puede tener varios registros)
    ///
    /// Legacy: rrhh.trabajador_formacion (SQL Server).
    ...
    /// </summary>
    public class TrabajadorFormacion : IAuditableEntity
    {
        ...
        public string? NivelEducativoCode { get; set; } // legacy: nivel_educativo_id
        public NivelEducativo? NivelEducativo { get; set; }
        public string? GradoInstruccionCode { get; set; } // legacy: grado_instruccion_id
        public GradoInstruccion? GradoInstruccion { get; set; }
        public string? TituloCode { get; set; } // legacy: titulo_id
        public Titulo? Titulo { get; set; }
        public string? EspecialidadCode { get; set; } // legacy: especialidad_id
        public EspecialidadTrabajador? Especialidad { get; set; }
        public string? TipoCentroFormacionCode { get; set; } // legacy: tipo_centro_formacion_id
        public TipoCentroFormacion? TipoCentroFormacion { get; set; }
        public string? ModalidadFormativaCode { get; set; } // legacy: modalidad_formativa_id
        public ModalidadFormativa? ModalidadFormativa { get; set; }
