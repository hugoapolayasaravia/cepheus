...
{
    /// <summary>
    /// Antecedentes declarados por el trabajador
    ///
    /// Legacy: rrhh.trabajador_antecedente (SQL Server).
    ...
    /// </summary>
    public class TrabajadorAntecedente : IAuditableEntity
    {
        ...
        public bool TieneAntecedentes { get; set; } // legacy: tiene_antecedentes (default 0)
        public string? Descripcion { get; set; } // legacy: descripcion
