...
{
    /// <summary>
    /// Sexo del trabajador. Catálogo del módulo RRHH.
    ///
    /// Fuente: script RRHH provisto (rrhh.sexo).
    ...
    ///   activo  -> IsActive
    /// </summary>
    public class Sexo : IAuditableEntity
    {
        /// <summary>
        /// Código del sexo (PK natural, hasta 10 caracteres, correlativo).
        /// </summary>
