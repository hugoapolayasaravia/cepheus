...
{
    /// <summary>
    /// Entidad Prestadora de Salud (EPS) del trabajador. Catálogo del módulo RRHH.
    ///
    /// Fuente: script RRHH provisto (rrhh.eps).
    ...
    ///   activo  -> IsActive
    /// </summary>
    public class Eps : IAuditableEntity
    {
        /// <summary>
        /// Código de la EPS (PK natural, hasta 20 caracteres, correlativo).
        /// </summary>
