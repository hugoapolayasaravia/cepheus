...
{
    /// <summary>
    /// Estado civil del trabajador. Catálogo del módulo RRHH.
    ///
    /// Fuente: script RRHH provisto (rrhh.estado_civil).
    ...
    ///   activo  -> IsActive
    /// </summary>
    public class EstadoCivil : IAuditableEntity
    {
        /// <summary>
        /// Código del estado civil (PK natural, hasta 10 caracteres, correlativo).
        /// </summary>
