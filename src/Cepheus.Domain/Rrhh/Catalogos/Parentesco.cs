...
{
    /// <summary>
    /// Parentesco (relación familiar) usado en contactos y dependientes del trabajador.
    /// Catálogo del módulo RRHH.
    ///
    /// Fuente: script RRHH provisto (rrhh.parentesco).
    ...
    ///   activo  -> IsActive
    /// </summary>
    public class Parentesco : IAuditableEntity
    {
        /// <summary>
        /// Código del parentesco (PK natural, hasta 10 caracteres, correlativo).
        /// </summary>
