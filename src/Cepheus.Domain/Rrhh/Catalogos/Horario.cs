...
{
    /// <summary>
    /// Horario de trabajo del trabajador. Catálogo del módulo RRHH.
    ///
    /// Fuente: script RRHH provisto (rrhh.horario).
    ...
    ///   activo  -> IsActive
    /// </summary>
    public class Horario : IAuditableEntity
    {
        /// <summary>
        /// Código del horario (PK natural, hasta 20 caracteres, correlativo).
        /// </summary>
