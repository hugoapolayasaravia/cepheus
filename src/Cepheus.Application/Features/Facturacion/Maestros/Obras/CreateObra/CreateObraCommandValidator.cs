...
namespace Cepheus.Application.Features.Facturacion.Maestros.Obras.CreateObra
{
    public class CreateObraCommandValidator : AbstractValidator<CreateObraCommand>
    {
        ...
        public CreateObraCommandValidator(IUnitOfWork uow)
        {
            _uow = uow;
            ...
            // Sin validación de existencia: Cobrador aún no existe como tabla en el repositorio.
            ...
            // Sin validación de existencia: Vendedor aún no existe como tabla en el repositorio.
