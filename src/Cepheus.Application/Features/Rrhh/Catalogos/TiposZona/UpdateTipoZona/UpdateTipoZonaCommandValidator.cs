...
{
    public class UpdateTipoZonaCommandValidator : AbstractValidator<UpdateTipoZonaCommand>
    {
        public UpdateTipoZonaCommandValidator()
        {
            RuleFor(x => x.Code)
                .NotEmpty().WithMessage("El código del tipo de zona es obligatorio.")
