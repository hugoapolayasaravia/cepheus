...
{
    public class UpdateTipoTrabajadorCommandValidator : AbstractValidator<UpdateTipoTrabajadorCommand>
    {
        public UpdateTipoTrabajadorCommandValidator()
        {
            RuleFor(x => x.Code)
                .NotEmpty().WithMessage("El código del tipo de trabajador es obligatorio.")
