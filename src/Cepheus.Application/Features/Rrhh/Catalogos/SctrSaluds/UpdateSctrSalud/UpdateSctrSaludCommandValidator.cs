...
{
    public class UpdateSctrSaludCommandValidator : AbstractValidator<UpdateSctrSaludCommand>
    {
        public UpdateSctrSaludCommandValidator()
        {
            RuleFor(x => x.Code)
                .NotEmpty().WithMessage("El código de la cobertura de salud SCTR es obligatorio.")
