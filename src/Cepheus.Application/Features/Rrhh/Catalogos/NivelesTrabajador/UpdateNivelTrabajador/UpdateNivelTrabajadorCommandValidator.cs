...
{
    public class UpdateNivelTrabajadorCommandValidator : AbstractValidator<UpdateNivelTrabajadorCommand>
    {
        public UpdateNivelTrabajadorCommandValidator()
        {
            RuleFor(x => x.Code)
                .NotEmpty().WithMessage("El código del nivel es obligatorio.")
