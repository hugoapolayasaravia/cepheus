...
{
    public class UpdateEpsCommandValidator : AbstractValidator<UpdateEpsCommand>
    {
        public UpdateEpsCommandValidator()
        {
            RuleFor(x => x.Code)
                .NotEmpty().WithMessage("El código de la EPS es obligatorio.")
