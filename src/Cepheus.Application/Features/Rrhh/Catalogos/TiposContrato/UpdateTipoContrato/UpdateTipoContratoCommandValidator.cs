...
{
    public class UpdateTipoContratoCommandValidator : AbstractValidator<UpdateTipoContratoCommand>
    {
        public UpdateTipoContratoCommandValidator()
        {
            RuleFor(x => x.Code)
                .NotEmpty().WithMessage("El código del tipo de contrato es obligatorio.")
