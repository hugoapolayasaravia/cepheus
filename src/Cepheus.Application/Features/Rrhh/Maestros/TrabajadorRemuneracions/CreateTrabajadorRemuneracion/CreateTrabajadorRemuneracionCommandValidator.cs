...
namespace Cepheus.Application.Features.Rrhh.Maestros.TrabajadorRemuneracions.CreateTrabajadorRemuneracion
{
    ...
    /// </summary>
    public class CreateTrabajadorRemuneracionCommandValidator : AbstractValidator<CreateTrabajadorRemuneracionCommand>
    {
        public CreateTrabajadorRemuneracionCommandValidator()
        {
