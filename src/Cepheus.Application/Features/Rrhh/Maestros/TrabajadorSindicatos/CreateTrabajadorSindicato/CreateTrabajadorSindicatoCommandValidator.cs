...
namespace Cepheus.Application.Features.Rrhh.Maestros.TrabajadorSindicatos.CreateTrabajadorSindicato
{
    ...
    /// </summary>
    public class CreateTrabajadorSindicatoCommandValidator : AbstractValidator<CreateTrabajadorSindicatoCommand>
    {
        public CreateTrabajadorSindicatoCommandValidator()
        {
