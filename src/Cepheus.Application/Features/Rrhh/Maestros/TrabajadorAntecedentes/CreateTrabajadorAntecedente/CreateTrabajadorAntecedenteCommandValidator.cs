...
namespace Cepheus.Application.Features.Rrhh.Maestros.TrabajadorAntecedentes.CreateTrabajadorAntecedente
{
    ...
    /// </summary>
    public class CreateTrabajadorAntecedenteCommandValidator : AbstractValidator<CreateTrabajadorAntecedenteCommand>
    {
        public CreateTrabajadorAntecedenteCommandValidator()
        {
