...
{
    public class CreateTrabajadorLaboralCommandValidator
        : AbstractValidator<CreateTrabajadorLaboralCommand>
    {
        private readonly IUnitOfWork _uow;

        public CreateTrabajadorLaboralCommandValidator(IUnitOfWork uow)
        {
            _uow = uow;
