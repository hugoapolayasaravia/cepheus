...
{
    public class CreateTrabajadorSaludCommandValidator
        : AbstractValidator<CreateTrabajadorSaludCommand>
    {
        private readonly IUnitOfWork _uow;

        public CreateTrabajadorSaludCommandValidator(IUnitOfWork uow)
        {
            _uow = uow;
            ...
            RuleFor(x => x.TrabajadorCode)
                ...
                .WithMessage("El trabajador ya tiene un registro de información de salud.");
