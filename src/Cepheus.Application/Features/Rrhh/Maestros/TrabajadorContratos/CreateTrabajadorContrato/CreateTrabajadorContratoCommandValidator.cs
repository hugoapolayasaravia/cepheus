...
namespace Cepheus.Application.Features.Rrhh.Maestros.TrabajadorContratos.CreateTrabajadorContrato
{
    ...
    /// </summary>
    public class CreateTrabajadorContratoCommandValidator : AbstractValidator<CreateTrabajadorContratoCommand>
    {
        public CreateTrabajadorContratoCommandValidator()
        {
