...
namespace Cepheus.Application.Features.Rrhh.Maestros.TrabajadorFormacions.CreateTrabajadorFormacion
{
    ...
    /// </summary>
    public class CreateTrabajadorFormacionCommandValidator : AbstractValidator<CreateTrabajadorFormacionCommand>
    {
        public CreateTrabajadorFormacionCommandValidator()
        {
