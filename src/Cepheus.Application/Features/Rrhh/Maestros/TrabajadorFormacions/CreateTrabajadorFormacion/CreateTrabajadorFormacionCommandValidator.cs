...
{
    public class CreateTrabajadorFormacionCommandValidator
        : AbstractValidator<CreateTrabajadorFormacionCommand>
    {
        private readonly IUnitOfWork _uow;

        public CreateTrabajadorFormacionCommandValidator(IUnitOfWork uow)
        {
            _uow = uow;
