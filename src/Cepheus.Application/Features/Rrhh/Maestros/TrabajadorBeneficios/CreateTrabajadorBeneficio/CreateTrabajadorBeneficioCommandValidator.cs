...
namespace Cepheus.Application.Features.Rrhh.Maestros.TrabajadorBeneficios.CreateTrabajadorBeneficio
{
    ...
    /// </summary>
    public class CreateTrabajadorBeneficioCommandValidator : AbstractValidator<CreateTrabajadorBeneficioCommand>
    {
        public CreateTrabajadorBeneficioCommandValidator()
        {
