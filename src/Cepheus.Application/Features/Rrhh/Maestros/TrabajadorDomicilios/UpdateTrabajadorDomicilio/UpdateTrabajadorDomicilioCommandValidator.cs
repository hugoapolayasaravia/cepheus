...
{
    public class UpdateTrabajadorDomicilioCommandValidator : AbstractValidator<UpdateTrabajadorDomicilioCommand>
    {
        private readonly IUnitOfWork _uow;

        public UpdateTrabajadorDomicilioCommandValidator(IUnitOfWork uow)
        {
            _uow = uow;
