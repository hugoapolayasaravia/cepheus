...
namespace Cepheus.Application.Features.Rrhh.Maestros.TrabajadorVacacions.CreateTrabajadorVacacion
{
    ...
    /// </summary>
    public class CreateTrabajadorVacacionCommandValidator : AbstractValidator<CreateTrabajadorVacacionCommand>
    {
        public CreateTrabajadorVacacionCommandValidator()
        {
